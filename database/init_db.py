...
CREATE INDEX IF NOT EXISTS idx_bid_orders_status ON bid_orders(Status, CreatedAt);
...
CREATE INDEX IF NOT EXISTS idx_trade_history_player ON trade_history(PlayerID, Star, CreatedAt DESC);
...
CREATE INDEX IF NOT EXISTS idx_inbox_user ON inbox(User, Read, CreatedAt DESC);
"""
