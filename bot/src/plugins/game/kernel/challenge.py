...
from game.model.npc_formation import NpcFormation
...
from game.model.challenge_times import ChallengeTimes
...
async def challenge_matcher_handler(bot: Bot, event: Event, state: dict):
