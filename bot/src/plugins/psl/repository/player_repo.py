...
def _row_to_player(row) -> PlayerData:
    return PlayerData(
        ...
        club=row[9] or "",
        crossing=row[56] or 0,
        finishing=row[57] or 0,
        heading_accuracy=row[58] or 0,
        short_passing=row[59] or 0,
        volleys=row[60] or 0,
        dribbling=row[61] or 0,
        curve=row[62] or 0,
        fk_accuracy=row[63] or 0,
        long_passing=row[64] or 0,
        ball_control=row[65] or 0,
        acceleration=row[66] or 0,
        sprint_speed=row[67] or 0,
        agility=row[68] or 0,
        reactions=row[69] or 0,
        balance=row[70] or 0,
        shot_power=row[71] or 0,
        jumping=row[72] or 0,
        stamina=row[73] or 0,
        strength=row[74] or 0,
        long_shots=row[75] or 0,
        aggression=row[76] or 0,
        interceptions=row[77] or 0,
        positioning=row[78] or 0,
        vision=row[79] or 0,
        penalties=row[80] or 0,
        composure=row[81] or 0,
        defensive_awareness=row[82] or 0,
        standing_tackle=row[83] or 0,
        sliding_tackle=row[84] or 0,
        gk_diving=row[85] or 0,
        gk_handling=row[86] or 0,
        gk_kicking=row[87] or 0,
        gk_positioning=row[88] or 0,
        gk_reflexes=row[89] or 0,
    )
