...
def format_stats(result: MatchResult) -> str:
    ...
    stats = [
        ...
        (str(home.shots_in_box), "禁区射门", str(away.shots_in_box)),
        (str(home.passes), "传球", str(away.passes)),
        (home_pass_rate, "传球成功率", away_pass_rate),
        (str(home.final_third_entries), "进攻三区进入", str(away.final_third_entries)),
